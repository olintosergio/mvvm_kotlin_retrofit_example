package app.elevuslabs.mvvm.adapter

import android.view.LayoutInflater
import android.view.ViewGroup
import androidx.recyclerview.widget.RecyclerView
import app.elevuslabs.mvvm.R
import app.elevuslabs.mvvm.databinding.ResItemLiveBinding
import app.elevuslabs.mvvm.models.Live
import com.bumptech.glide.Glide
import com.bumptech.glide.request.RequestOptions

class MainAdapter(private val onItemClicke: (Live) -> Unit) : RecyclerView.Adapter<MainViewHolder>() {
